<?php
  ...
  if ($vced != "Cedula Invalida"){
    $cad = "UPDATE `administrador` SET admin_cedula='".$cedula."',"."admin_nombre='".$nombre."',"."admin_apellido='".$apellido."',"."admin_correo='".$correo."',admin_password='".$password."',admin_rol='".$rol."' WHERE admin_id=".$id;
