                    ...
                    <div class="col-sm-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form enctype="multipart/form-data" method="POST" action="funciones/administrador/CrearDocente.php" class="clearfix">
                                    <div class="form-group">
                                      <div>
                                        <label id="cedulaMsj"></label>
                                      </div>
                                        <label for="cedula" class="control-label">Cédula</label>
                                        <input type="name" class="form-control" name="cedula" id="cedula" value="" placeholder="Cédula" onkeyup="validar()" onchange="validar()" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="telefono" value="" min="0" placeholder="2256943" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="especialidad" class="control-label">Especialidad</label>
                                        <input type="text" class="form-control" name="especialidad" value="" placeholder="Especialidad" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="radio"  name="genero" value="Femenino" checked>Femenino<br>
                                        </center>
                                    </div>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="clave" value="" placeholder="CLave" required>
                                    </div>
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <button type="submit" name="update" id="save" class="btn btn-info"  style='display:none;'>Agregar</button>
                                        </center>
